						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							...
							<div class="d-flex align-items-center py-3 py-md-1">
								...
								<div class="me-4">
									...
									<!--begin::Menu 1-->
									<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_65a108d06cd14">
										<!--begin::Header-->
										<div class="px-7 py-5">
										...
										<div class="px-7 py-5">
											...
											<div class="mb-10">
												...
												<!--begin::Input-->
												<div>
													<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_65a108d06cd14" data-allow-clear="true">
														<option></option>
								...
								<div class="col-xl-8">
									...
									<div class="row gx-5 gx-xl-8 mb-5 mb-xl-8">
										<div class="col-xl-3 mb-5 mb-xl-0">
											...
											<div class="card h-150px bgi-no-repeat bgi-size-cover bgi-position-y-center card-xl-stretch border-0" style="background-image:url('assets/media/stock/600x600/img-22.jpg')">
												<!--begin::Body-->
