...
@section('title', 'Landing Page E-KP')
        ...
        <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg" style="background-image: url(assets/media/svg/illustrations/landing.svg)">
            <div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
                <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                    <h1 class="text-white lh-base fw-bold fs-2x fs-lg-3x mb-15">Bangun Solusi Digital Terbaik
                    <br />untuk  
                    <span style="background: linear-gradient(to right, #12CE5D 0%, #FFD80C 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
                        <span id="kt_landing_hero_text">Manajemen Kerja Perkantoran</span>
                    </span></h1>
                    <a href="{{ route('register') }}" class="btn btn-primary">Sign Up E-KP</a>
                </div>
                <div class="d-flex flex-center flex-wrap position-relative px-5">
                    <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="STMIK BANDUNG">
                        <img src="assets/media/logos/stmik.png" class="mh-30px mh-lg-40px" alt="" />
                    </div>
                    <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="STMIK BANDUNG">
                        <img src="assets/media/logos/dataquest.png" class="mh-30px mh-lg-40px" alt="" />
                    </div>
                </div>
            </div>
        </div>
