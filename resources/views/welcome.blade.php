            ...
            <div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
                <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                    ...
                    <p class="fs-4 text-gray-500 fw-semibold mb-10">
                        Kelola tugas, pantau produktivitas, dan sederhanakan manajemen perkantoran Anda dalam satu sistem web yang terintegrasi dan efisien.
                        <br/>
                        Optimalkan kinerja perusahaan dengan platform pencatatan pekerjaan harian yang cerdas.
                    </p>
                    @guest
            ...
            <div class="row w-100 gy-10 mb-md-20">
                ...
                <div class="col-md-4 px-5">
                    <div class="text-center">
                        ...
                        <div class="fs-5 fs-lg-3 fw-bold text-gray-900 mb-5">Laporan Kerja Harian Digital</div>
                        <div class="fw-semibold fs-6 fs-lg-4 text-muted">Catat setiap aktivitas pekerjaan harian secara terstruktur dan real-time.</div>
                    </div>
                </div>
                <!-- Feature 2 -->
                <div class="col-md-4 px-5">
                    <div class="text-center">
                        ...
                        <div class="fs-5 fs-lg-3 fw-bold text-gray-900 mb-5">Monitoring Progres Pekerjaan</div>
                        <div class="fw-semibold fs-6 fs-lg-4 text-muted">Pantau status penyelesaian setiap tugas dalam satu dashboard.</div>
                    </div>
                </div>
                <!-- Feature 3 -->
                <div class="col-md-4 px-5">
