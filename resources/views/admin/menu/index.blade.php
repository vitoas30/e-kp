...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Menu</h1>
            ...
            <div class="card-header border-0 pt-6">
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" id="searchMenu" class="form-control form-control-solid w-250px ps-13" placeholder="Search menu..." />
                    </div>
                </div>
                ...
                <div class="card-toolbar">
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addMenuModal">
                    ...
                    <table id="kt_table_employee_type" class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            @forelse ($menus as $menu)
                                <tr>
                                    <td>
                                        <span class="text-gray-700 fw-bold mb-1 fs-6">{{ $menu->name }}</span>
                                    </td>
                                    <td>
                                        <span class="text-gray-700">{{ $menu->description ?? '-' }}</span>
                                    </td>
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-5 w-125px py-4" data-kt-menu="true">
                                            <div class="menu-item px-3">
                                                <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#editMenuModal{{ $menu->id }}" class="menu-link px-3 text-warning">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="javascript:void(0);" class="menu-link px-3 text-danger deleteAlert" title="Delete" data-url="{{route('admin.menu.destroy', $menu->id)}}">
                                ...
                                <tr id="emptyStateRow">
                                    <td colspan="5" class="text-center text-muted py-5">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <span class="fw-semibold fs-5">No menu found.</span>
                                            <span class="text-muted fs-7">Start by adding a new menu</span>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg rounded-3">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="addMenuModalLabel">
            ...
            <form action="{{ route('admin.menu.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-4">
                        <label for="name" class="form-label fw-semibold required">Menu Name</label>
                        <input type="text" name="name" id="name" class="form-control form-control-solid" placeholder="Enter menu name" value="{{ old('name') }}" required>
                    </div>
                    <div class="mb-3">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg rounded-3">
            ...
            <form action="{{ route('admin.menu.update', $menu->id) }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-4">
                        <label for="name_edit{{ $menu->id }}" class="form-label fw-semibold required">Menu Name</label>
                        <input type="text" name="name" id="name_edit{{ $menu->id }}" class="form-control form-control-solid" placeholder="Enter menu name" value="{{ $menu->name }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="description_edit{{ $menu->id }}" class="form-label fw-semibold">Description</label>
                        <textarea name="description" id="description_edit{{ $menu->id }}" class="form-control form-control-solid" rows="3" placeholder="Enter description (optional)">{{ $menu->description }}</textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancel</button>
...
<script>
    ...
    $(document).ready(function() {
        ...
        let dataTable = null;
        const hasData = {{ $menus->count() > 0 ? 'true' : 'false' }};
