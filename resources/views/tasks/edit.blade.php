            ...
            <div class="card">
                <div class="card-header border-1 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">Form Update Task</h3>
                    </div>
                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <input type="date" class="form-control" name="start_date" id="start_date" 
                                           placeholder="Start Date" value="{{ $task->start_date }}" />
                                </div>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <textarea name="description" id="description" class="form-control form-control-solid" rows="3" placeholder="Enter description (optional)">{{ $task->description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" 
                                           placeholder="Full Name" value="{{ $task->name }}" required />
                                </div>

                                <div class="d-flex flex-column mb-8 fv-row">
                                    <label for="due_date" class="form-label">Due Date</label>
                                    <input type="date" class="form-control" name="due_date" id="due_date" 
                                           placeholder="Due Date" value="{{ $task->due_date }}" />
                                </div>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <select id="priority" name="priority" class="form-select">
                                        ...
                                        <option value="high" {{ $task->priority == 'high' ? 'selected' : '' }}>Hight</option>
                                    ...
                                    <div class="d-flex mt-2">
                                        <div class="form-check form-check-custom form-check-warning me-14">
                                            <input class="form-check-input" type="radio" name="status" value="todo" 
                                                   id="todo" {{ $task->status == "todo" ? 'checked' : '' }}>
