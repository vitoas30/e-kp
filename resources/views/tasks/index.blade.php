                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" id="searchProjects" class="form-control form-control-solid w-250px ps-13" placeholder="Search task" />
                        </div>
                    </div>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('admin.tasks.show', $task->id) }}" class="menu-link px-3">
                                                        <i class="ki-solid ki-eye fs-5 me-2"></i>View
                                                    </a>
                                                </div>
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('admin.tasks.edit', $task->id) }}" class="menu-link px-3">
                                                        <i class="ki-solid ki-pencil fs-5 me-2"></i>Edit
                                                    </a>
                                                </div>
                                                <div class="menu-item px-3">
                                                    <a href="javascript:void(0);" class="menu-link px-3 text-danger deleteAlert" 
                                                    data-url="{{ route('admin.tasks.destroy', $task->id) }}">
                                    ...
                                    <tr>
                                        <td colspan="9" class="text-center text-muted py-10">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <span class="fw-semibold fs-5">No tasks found</span>
                                                <span class="text-muted fs-7 mt-2">Start by adding a new task</span>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
